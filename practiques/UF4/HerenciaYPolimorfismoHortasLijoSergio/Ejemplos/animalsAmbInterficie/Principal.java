...
public class Principal {
    ...
    public static void main(String[] args) {
        Persona per1 = new Persona("Arnau", 9);
        ...
        GosPigall go3 = new GosPigall("Brutus",3,5);
        Vaca v1 = new Vaca("Margarita", 5);
        Pedra ped1 = new Pedra(1000000);

        //Animal an = new Animal("Arnau",9);
        Animal an1;
        ...
        // Què fan els gossosPigall?
        System.out.print("\n\nQuè fa el " + go3.getNom() + "?\n");
        System.out.print(go3.respira() + "\n");
        System.out.print(go3.menja() + "\n");
        System.out.print(go3.dorm() + "\n");
        System.out.print(go3.parla() + "\n");
        System.out.print(go3.treball() + "\n");
